...
KYCOpsCM_StartDate = DT.datetime(2020, 10, 1, 0, 0)
KYCOpsCM_EndDate = DT.datetime(2030, 12, 31, 0, 0) ####### To be updated after confirm no KYC CM #######

####### Please this field to last day #######
MICutOffDate = DT.datetime(2025, 11, 2, 0, 0)
